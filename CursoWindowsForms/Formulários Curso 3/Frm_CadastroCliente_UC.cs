...
using CursoWindowsFormsBiblioteca.FicharioDataSetTableAdapters;
    ...
    public partial class Frm_CadastroCliente_UC : UserControl
    {
        ...
        private void novoToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //C.IncluirFichario("C:\\Users\\Ellen\\source\\repos\\Fichario");
        ...
        private void abrirToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    //C = C.BuscarFichario(Txt_Codigo.Text, "C:\\Users\\Ellen\\source\\repos\\Fichario");
                    if (C == null)
                    {
        ...
        private void salvarToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    //C.AlterarFichario("C:\\Users\\Ellen\\source\\repos\\Fichario");
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (Db.DialogResult == DialogResult.Yes)
                        {
                            ...
                            //C.ApagarFichario("C:\\Users\\Ellen\\source\\repos\\Fichario");
        ...
        private void Btn_Busca_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //var ListaBusca = C.BuscarFicharioTodosSQLServer("Cliente");
                //var ListaBusca = C.BuscarFicharioTodos("C:\\Users\\Ellen\\source\\repos\\Fichario");
                ...
                if (FForm.DialogResult == DialogResult.OK)
                {
                    ...
                    //C = C.BuscarFichario(idSelect, "C:\\Users\\Ellen\\source\\repos\\Fichario");
                    if (C == null)
                    {
                        MessageBox.Show("Identificador não encontrado.", "ByteBank", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
